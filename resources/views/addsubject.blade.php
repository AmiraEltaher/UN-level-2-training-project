...
<div class="container">
  ...
  <form action="{{route('displaysubject')}}" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group">
      ...
      <input type="time" class="form-control" id="start_time" placeholder="Enter start time" name="start_time" value="{{ old('start_time') }}">
      @error('start_time')
        <div class="alert alert-warning">{{ $message }}</div>
      @enderror
    </div>
    <div class="form-group">
      ...
      <input type="time" class="form-control" id="end_time" placeholder="Enter end time" name="end_time" value="{{ old('end_time') }}">
      @error('end_time')
        <div class="alert alert-warning">{{ $message }}</div>
      @enderror
    </div>
